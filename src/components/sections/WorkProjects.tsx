        ...
        <div className="container-large">
          <div className="work-projects_component">
            ...
            <div className="work-projects_nav">
              <Link href="/work" aria-current="page" data-audio={audio.secondaryHover} className="work-projects_nav-wrapper w-inline-block w--current">
                <div className="text-size-tiny text-style-allcaps">Portfolio</div>
              </Link>
              <Link href="/experiments" data-audio={audio.secondaryHover} className="work-projects_nav-wrapper w-inline-block">
                <div className="text-size-tiny text-style-allcaps">[See Labs]</div>
              </Link>
                ...
                <div key={project.index} className="work-projects_card-layout">
                  ...
                  <div className="work-projects_card-bottom">
                    ...
                    <div className="work-projects_card-result">
                      ...
                      <div className="text-size-small text-color-secondary">{project.resultLabel}</div>
                    </div>
                  </div>
                </div>
              ))}
