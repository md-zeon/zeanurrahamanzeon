                  ...
                  <div className="relative z-2 flex w-full flex-col gap-8 max-[991px]:gap-4 max-[767px]:gap-2">
                    <div className="flex w-full flex-col gap-6">
                      <div className="pl-4 max-[991px]:pl-0">
                        ...
                        <div className="flex -mt-2 items-end justify-start gap-x-4 gap-y-4 pl-[5vw] desktop:pl-16 max-[991px]:pl-0 max-[991px]:pr-[17vw] max-[767px]:mt-[-0.3rem] max-[767px]:gap-y-2">
                          <div
