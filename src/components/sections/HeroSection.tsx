...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.set([".home-header_header-wrapper", ".home-header_video-wrapper", ".home-header_cta-wrapper"], { autoAlpha: 0, y: 40 });
      ...
      gsap.to(".home-header_header-wrapper, .home-header_video-wrapper, .home-header_cta-wrapper", {
        autoAlpha: 1,
        y: 0,
        duration: 0.9,
        stagger: 0.12,
  ...
  return (
    <header data-projects-section="first" data-parallax-type="section" className="section_home-header" ref={ref}>
                ...
                <div className="w-layout-grid home-header_content">
                        ...
                        <div className="home-header_header-wrapper is-first">
                          <div className="home-header_p-wrapper">
                            <div className="home-header_p">
                              <p id="home-hero-name" className="text-size-medium">
                                {brand.heroName}
                              </p>
                            </div>
                          </div>
                          <h1 id="home-hero-header-1" className="heading-style-h0">
                            {brand.heroLine1}
                          </h1>
                        </div>
                        <div className="home-header_header-wrapper is-middle">
                          <div id="home-hero-header-2" className="heading-style-h0">
                            {brand.heroLine2}
                          </div>
                        </div>
                  ...
                  <div className="home-header_content-down">
                    <div className="home-header_video-wrapper">
                      <div className="home-header_video-border w-embed" aria-hidden="true">
                      ...
                      <div className="home-header_video-w">
                        <div data-parallax-type="video" className="home-header_loop-video is-home-hero w-embed">
                          <AutoVideo src={brand.heroVideo} />
                        </div>
                      </div>
                      <div className="home-header_video-misc">
                        <div className="text-caption-2 text-color-teritary">{brand.heroVideoCaption}</div>
                      </div>
                    </div>
                    <div className="home-header_cta-layout">
                      <div className="home-header_badge-component">
                        <div className="home-header_badge-icon-wrapper">
                          <div id="home-hero-asterisk" className="home-header_asterisk w-embed">
                            <Asterisk />
                          </div>
                        </div>
