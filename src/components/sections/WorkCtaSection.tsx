    ...
    <section className="background-color-primary relative z-[2]" ref={ref}>
      <div className="padding-global is-bigger">
        <div className="container-large">
          <div>
            <div header-animation-type="container" className="grid grid-cols-1 justify-between border-b border-r border-white-20">
              ...
              <div className="border-x border-white-20 p-20 max-[991px]:p-12 max-[767px]:p-8">
                <div className="relative z-[2] flex aspect-[1.27] w-full items-end justify-center">
                  ...
                  <div className="relative flex h-full w-full items-center justify-center [clip-path:polygon(98.5%_0,98.5%_6%,100%_7%,100%_100%,10%_100%,0_90%,0_0)]">
                    <div data-parallax-type="video" className="cta_loop-video is-1 absolute inset-auto z-[1] block aspect-square h-[110%] w-[110%] flex-none bg-neutral-dark-grey object-cover max-[767px]:h-[120%] max-[767px]:w-[120%]">
                      <AutoVideo src={cta.videoLoop} />
                    </div>
                    <div data-parallax-type="video" className="cta_loop-video is-2 absolute inset-auto z-[2] hidden aspect-square h-[110%] w-[110%] flex-none bg-neutral-dark-grey object-cover max-[767px]:h-[120%] max-[767px]:w-[120%]">
                      <video
                        muted
                        loop
                        playsInline
                    ...
                    <div data-parallax-type="video" className="cta_loop-video is-3 absolute inset-auto z-[3] hidden aspect-square h-[110%] w-[110%] flex-none bg-neutral-dark-grey object-cover max-[767px]:h-[120%] max-[767px]:w-[120%]">
                      <video
                        muted
                        loop
                        playsInline
                ...
                <div className="flex items-start justify-center px-4 py-24 max-[991px]:relative max-[991px]:z-[4] max-[991px]:justify-end max-[991px]:items-start max-[991px]:border-x max-[991px]:border-white-20 max-[991px]:pb-12 max-[991px]:pt-0 max-[479px]:justify-center max-[479px]:items-start">
                  <div className="flex w-full max-w-[23.25rem] flex-col gap-4 overflow-hidden rounded-lg border border-white-20 p-4 backdrop-blur-[100px] bg-[#efefe60d] max-[991px]:-mt-[5.6rem] max-[991px]:mr-[3.6rem] max-[767px]:-mt-[3.1rem] max-[767px]:mr-0 max-[479px]:mt-0">
                    ...
                    <div className="flex items-center justify-start gap-2">
                      <div className="h-8 w-8 flex-none overflow-hidden rounded-full">
                        <img src={photos.ellipseBlack} loading="lazy" alt="" className="h-full w-full object-cover" />
                      </div>
                      <div>
                        <div className="text-[0.625rem] font-light leading-[120%] text-neutral-light-grey">{cta.chat.name}</div>
                    ...
                    <div className="cta_chat-content is-client is-1 flex items-center justify-end gap-2">
                      <div className="flex flex-col items-end justify-end">
                        <div className="overflow-hidden">
                          <div id="cta-chat-partner-1" className="text-[0.625rem] font-light leading-[120%] text-neutral-light-grey">
                            USER_1230
                          </div>
                        </div>
                      ...
                      <div id="cta-chat-partner-photo-1" className="flex h-8 w-8 flex-none items-center justify-center overflow-hidden rounded-full bg-brand-purple">
                    ...
                    <div className="cta_chat-content is-client is-2 flex items-center justify-end gap-2">
                      <div className="flex flex-col items-end justify-end">
                        <div className="overflow-hidden">
                          <div id="cta-chat-partner-2" className="text-[0.625rem] font-light leading-[120%] text-neutral-light-grey">
                            USER_1230
                          </div>
                        </div>
                      ...
                      <div id="cta-chat-partner-photo-2" className="flex h-8 w-8 flex-none items-center justify-center overflow-hidden rounded-full bg-brand-purple">
                        <div className="text-size-small">U</div>
                      </div>
                    </div>
                    ...
                    <div className="cta_chat-content is-1 flex items-center justify-start gap-2">
                      <div id="cta-chat-me-photo-1" className="h-8 w-8 flex-none overflow-hidden rounded-full">
                        <img src={photos.ellipseBlack} loading="lazy" alt="" className="h-full w-full object-cover" />
                      </div>
                      <div>
                        <div className="overflow-hidden">
                          <div id="cta-chat-me-1" className="text-[0.625rem] font-light leading-[120%] text-neutral-light-grey">
                            {cta.chat.name}
                          </div>
                        </div>
                    ...
                    <div className="cta_chat-content is-2 flex items-center justify-start gap-2">
                      <div id="cta-chat-me-photo-2" className="h-8 w-8 flex-none overflow-hidden rounded-full">
                        <img src={photos.ellipseBlack} loading="lazy" alt="" className="h-full w-full object-cover" />
                      </div>
                      <div>
                        <div className="overflow-hidden">
                          <div id="cta-chat-me-2" className="text-[0.625rem] font-light leading-[120%] text-neutral-light-grey">
                            {cta.chat.name}
                          </div>
                        </div>
