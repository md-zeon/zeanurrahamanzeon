  ...
  return (
    <div className="icon-embed-xxsmall w-embed">
      ...
      >
        ...
        />
        <path
          d="M5.77954 15.7468H4.77954C4.24911 15.7468 3.7404 15.5361 3.36533 15.161C2.99025 14.7859 2.77954 14.2772 2.77954 13.7468V4.74677C2.77954 4.21633 2.99025 3.70762 3.36533 3.33255C3.7404 2.95748 4.24911 2.74677 4.77954 2.74677H13.7795C14.31 2.74677 14.8187 2.95748 15.1938 3.33255C15.5688 3.70762 15.7795 4.21633 15.7795 4.74677V5.74677"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export default function ContactForm() {
  ...
  const handleCopy = async (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    const copyText =
      emailRef.current?.querySelector("[copy-text]")?.textContent;
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    <a
                      ...
                      className="text-style-nounderline w-inline-block"
                    >
                    ...
                    <a
                      ...
                      href="#"
                      className="relative flex h-4 w-4 w-inline-block items-center justify-center overflow-hidden"
                      onClick={handleCopy}
                    >
                  ...
                  <div className="grid auto-cols-fr grid-cols-2 gap-8 max-[767px]:grid-cols-1">
                    ...
                    <div className="relative">
                      ...
                      <div className="pt-2">
                        <label
                          htmlFor="Budget"
                          className="text-size-tiny text-color-secondary"
                        >
