          ...
          <div className="flex flex-col">
            ...
            <div data-slider="list" className="relative flex border-x border-[#444]">
              {workProjects.map((project) => (
                <div key={project.index} data-slider="slide" className="relative z-[1] flex w-1/2 flex-none flex-col gap-4 border-y border-white-20 px-4 py-8 max-[767px]:w-full max-[767px]:py-4">
